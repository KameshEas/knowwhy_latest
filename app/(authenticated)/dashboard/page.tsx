...
export default async function DashboardPage() {
  ...
  const setupSteps = [
    {
      ...
      // Mark this as completed by default for Google-authenticated users
      // (treat login via Google as having the account connected).
      completed: true,
      href: "/meetings",
    },
    {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Client component handles dismissal persistence */}
      <GettingStartedCard setupSteps={setupSteps} completedSteps={completedSteps} setupProgress={setupProgress} />
